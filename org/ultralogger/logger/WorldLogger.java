...
public class WorldLogger implements Listener{
	...
	public void onPortal(PortalCreateEvent e){
		...
		out.log("["+e.getWorld().getName()+"] "+plugin.translate("portal.create")+" "+plugin.translate("in")+" ["+(int)i.getLocation().getX()+","+
	...
	public void onGrow(StructureGrowEvent e){
		...
		out.log("["+e.getWorld().getName()+"] a "+e.getSpecies().name()+" "+plugin.translate("structure.grow")+" "+plugin.translate("in")+" ["+(int)i.getX()+","+(int)i.getY()+","+(int)i.getZ()+"] "+bonemeal);
	}
	@EventHandler
	public void onSpawnChanges(SpawnChangeEvent e){
		...
		out.log("["+e.getWorld().getName()+"] "+plugin.translate("spawn.change")+" "+plugin.translate("from")+" ["+(int)i.getX()+","+(int)i.getY()+","+(int)i.getZ()+"] "+plugin.translate("to")+" ["+(int)it.getX()+","+(int)it.getY()+","+(int)it.getZ()+"] ");
	}
	public void disable(){
		out.close();
	}
